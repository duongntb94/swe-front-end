              ...
              <div className="col-12">
                <div className="feature text-center">
                  <div>
                    ...
                    <p className="pb-3">
                      ESHOP HTML template is an apparently simple but highly
                      functional tempalate designed for creating a flourisahing
                      online business.
                    </p>
                  </div>
                </div>
            ...
            <div className="row feature_row">
              <div className="col-xl-3 col-md-6 ">
                <div className="feature-box">
                  ...
                  <p className="para">
                    ESHOP is a clean and morfern responsive template.it will
                    perfectly suit for any type of online store
                  </p>
                </div>
              </div>
              <div className="col-xl-3 col-md-6 ">
                <div className="feature-box">
                  ...
                  <p className="para">
                    ESHOP has powerful backend admin panel to manage products,
                    sales, discount coupons, orders, user, vendor and much more.
                  </p>
                </div>
              </div>
              <div className="col-xl-3 col-md-6">
                <div className="feature-box">
                  ...
                  <p className="para">
                    ESHOP comes with 4 email template which include two order
              ...
              <div className="col-xl-3 col-md-6">
                <div className="feature-box">
                  ...
                  <p className="para">
                    ESHOP provides multiple portfolio pages which includes 3
                    grid view & 4 masonary view.
                  </p>
                </div>
              </div>
              <div className="col-xl-3 col-md-6 ">
              ...
              <div className="col-xl-3 col-md-6 ">
                <div className="feature-box">
                  ...
                  <p className="para">
                    ...
                    needs , it has auto resize image option in multikart
                  </p>
                </div>
              </div>
              <div className="col-xl-3 col-md-6">
              ...
              <div className="col-xl-3 col-md-6">
                <div className="feature-box">
                  ...
                  <p className="para">
                    Design your website LTR or RTL , Multikart supports
        ...
        <section id="admin" className="section-b-space pt-0">
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-3 col-sm-6 col-12 demo-box">
                <a
                  href="https://react.pixelstrap.com/multikart-admin/dashboard"
                  target="_blank"
                >
                  <img
              ...
              <div className="col-xl-3 col-sm-6 col-12 demo-box">
                <a
                  href="https://react.pixelstrap.com/multikart-admin/products/physical/product-list"
                  target="_blank"
                >
                  <img
              ...
              <div className="col-xl-3 col-sm-6 col-12 demo-box">
                <a
                  href="https://react.pixelstrap.com/multikart-admin/reports/report"
                  target="_blank"
                >
                  <img
              ...
              <div className="col-xl-3 col-sm-6 col-12 demo-box">
                <a
                  href="https://react.pixelstrap.com/multikart-admin/media"
                  target="_blank"
                >
                  <img
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-4 offset-md-1 text-center center-part">
                ...
                <p className="pb-3">
                  ESHOP come with 4+ email template which include two order
                  success template & two email template{" "}
                </p>
                <img
              ...
              <div className="col">
                <div className="footer-section">
                  <div>
                    ...
                    <h2>
                      purchase the multikart <br />& create beautiful online
                      store
                    </h2>
                    <a
                      target="_blank"
